...
def orderCreate():
    ...
    order1.orderType = "STP LMT"    # Sets order type to market buy
    order1.transmit = True
    order1.totalQuantity = 5   # Setting a static quantity of 10
    order1.lmtPrice = 130
    order1.auxPrice = 110
...
def orderCancel(ordNum:int):

    #orderObject = orderCreate()
    app.cancelOrder(ordNum)
